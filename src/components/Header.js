...
export default function Header({ title }) {
  ...
  return (
    <div className="relative box-border flex w-full items-center justify-between p-6 font-semibold">
      ...
      <button
        className="flex h-8 w-24 cursor-pointer select-none items-center justify-center rounded-full bg-gradient-to-r from-teal-600 to-teal-400 text-center text-base text-white no-underline drop-shadow-xl"
